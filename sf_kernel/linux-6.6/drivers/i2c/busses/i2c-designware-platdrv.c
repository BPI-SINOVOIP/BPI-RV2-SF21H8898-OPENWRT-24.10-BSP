...
static struct dw_scl_sda_cfg sf_config = {
	.ss_hcnt = 0x3e0,
	.fs_hcnt = 0xf2,
	.hs_hcnt = 0x15,
	.ss_lcnt = 0x3e7,
...
static int dw_i2c_of_configure(struct platform_device *pdev)
{
	...
	struct dw_scl_sda_cfg *cfg = &sf_config;
	...
	case MODEL_SIFLOWER:
		...
		if(dev->timings.bus_freq_hz == 1000000){
			dev->fs_hcnt = 0x5c;
			dev->fs_lcnt = 0x63;
		}
		break;
...
static const struct of_device_id dw_i2c_of_match[] = {
	...
	{ .compatible = "siflower,designware-i2c", .data = (void *)MODEL_SIFLOWER },
	{},
};
