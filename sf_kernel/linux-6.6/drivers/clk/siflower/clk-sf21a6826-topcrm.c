...
static u8 sf21a6826_pll_test_get_parent(struct clk_hw *hw)
{
	struct sf_clk_common *cmn_priv = hw_to_sf_clk_common(hw);
...
static int sf21a6826_pll_test_set_parent(struct clk_hw *hw, u8 index)
{
	struct sf_clk_common *cmn_priv = hw_to_sf_clk_common(hw);
	unsigned long flags;
	spin_lock_irqsave(cmn_priv->lock, flags);
...
static const struct clk_ops sf21a6826_clk_pll_test_ops = {
	.recalc_rate = sf21a6826_muxdiv_recalc_rate,
	.determine_rate = sf21a6826_muxdiv_determine_rate,
	.set_rate = sf21a6826_muxdiv_set_rate,
	.get_parent = sf21a6826_pll_test_get_parent,
	.set_parent = sf21a6826_pll_test_set_parent,
};

static struct sf21a6826_clk_muxdiv muxdiv_pll_test = {
	.common = SF_CLK_COMMON("muxdiv_pll_test", clk_pll_test_parents,
				&sf21a6826_clk_pll_test_ops, 0),
	.mux = 0,
	.en = 0,
	.div_reg = 3,
	.div_offs = 24,
