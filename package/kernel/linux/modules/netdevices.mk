...
define KernelPackage/phy-siflower
   SUBMENU:=$(NETWORK_DEVICES_MENU)
   TITLE:=siflower SF1240 PHY driver
endef

define KernelPackage/phy-siflower/description
   Supports the siflower SF1240 PHY.
endef

SF1240FW_DIR:=$(TOPDIR)/SF1240_FW
define KernelPackage/phy-siflower/install
	$(INSTALL_DIR) $(1)/lib/firmware
	$(CP) $(SF1240FW_DIR)/sf1240_phy_patch.bin $(1)/lib/firmware/
endef

$(eval $(call KernelPackage,phy-siflower))
