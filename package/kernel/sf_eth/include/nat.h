...
void dpns_nat_hw_lookup4(struct dpns_nat_priv *priv, bool is_dnat, struct nat_ipv4_data *tb);
void dpns_nat_hw_lookup6(struct dpns_nat_priv *priv, bool is_dnat, struct nat_ipv6_data *tb);
