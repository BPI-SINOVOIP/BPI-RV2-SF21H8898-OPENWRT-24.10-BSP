...
void evlan_xlt_table_update(VLAN_t *priv, u8 iport_num, u8 oport_num, int valid, int old_ivid, int old_ovid, int new_ivid, int new_ovid, int old_ivid_mask, int old_ovid_mask, int evlan_act_idx);
